    ...
    <div className="main-container">
      <div className="about-barista">
        ...
        <p>
          ...
          the essential skills needed to work confidently in any café or start
        ...
        <p>
          ...
          behind the counter. By the end of the month, you won't just know how
          to brew coffee—you'll know how to craft experiences, connect with
          customers, and carry the confidence of a professional barista.
        </p>
      </div>
